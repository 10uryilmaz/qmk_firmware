...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [FN2] = LAYOUT_ansi_69(
        ...
        _______,           _______,  _______, _______, _______, BAT_LVL,     BAT_LVL,  _______, _______, _______,  _______,  _______,  _______, AS_UP,
        _______, _______,  _______,           _______,          _______,     _______,           _______,           _______,            AS_TOGG, AS_DOWN,  AS_RPT)
};
